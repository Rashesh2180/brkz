        ...
        {data.length > 0 &&
          data.map((ele) => (
            <SwiperSlide key={ele.id}>
              <div
                className=" h-full min-h-screen relative flex flex-col  justify-center items-center"
                style={{
                  backgroundImage: `linear-gradient(0deg,  black, #00000090), url(${ele.img})`,
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                }}
              >
                <div className="max-w-[950px] h-full z-[100000] mx-auto flex flex-col  justify-center items-center gap-8">
                  <h1 className="   text-center text-[62px] font-semibold text-secondary-dark leading-[77px]">
                    {ele.title_1}{" "}
                    <span className=" text-white">{ele.title_2}</span>
                  </h1>
                  <div className=" w-[100px] h-1 bg-[#b3c8cb] rounded-[25.1922px]"></div>
                  {ele.btn_name ? (
                    <Button text={ele.btn_name} />
                  ) : (
                    <div className="flex items-center gap-5">
                      <NavLink>
                        <img
                          src="/assets/images/logos/applelogo.png"
                          alt=""
                          className=" h-14 w-[200px] object-cover"
                        />
                      </NavLink>
                      <NavLink>
                        <img
                          src="/assets/images/logos/playstorelogo.png"
                          alt=""
                          className=" h-14 w-[200px] object-cover"
                        />
                      </NavLink>
                ...
                {/* <img
                  ...
                  className="absolute top-0 left-0 h-full right-0 bottom-0 bg-gradient-to-b from-transparent to-black opacity-90"
                  alt=""
                /> */}
              </div>
            </SwiperSlide>
